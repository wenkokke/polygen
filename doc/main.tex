...
%options ghci -XTypeApplications
%include lhs2TeX.fmt
%if style == poly
%format Cool          = "\Varid{Bool}"
%format toCool(b)     = b
%format pattern       = "\mathbf{pattern}"
%format enumFin       = "\Varid{enum}_{\Varid{Fin}}"
%format enumTy        = "\Varid{enum}_{\Varid{Ty}}"
%format enumTm        = "\Varid{enum}_{\Varid{Tm}}"
%format enumClosedTm  = "\Varid{enum}_{\Varid{ClosedTm}}"
%format extKindEnv    = "\Varid{ext}_{\Varid{KE}}"
%format extTySub      = "\Varid{ext}_{\Varid{TS}}"
%format extTyEnv      = "\Varid{ext}_{\Varid{TE}}"
%format raiseTyEnv    = "\Varid{raise}_{\Varid{TE}}"
%format appTySub      = "\Varid{app}_{\Varid{TS}}"
